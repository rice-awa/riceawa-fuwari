...
这个博客模板使用 [Astro](https://astro.build/) 构建。对于本指南中未提及的内容,你可以在 [Astro 文档](https://docs.astro.build/)中找到答案。
...
| `title`       | 文章标题。                                                                                                                                          |
| `published`   | 文章发布日期。                                                                                                                                       |
| `description` | 文章简短描述。显示在索引页面上。                                                                                                                       |
| `image`       | 文章封面图片路径。<br/>1. 以 `http://` 或 `https://` 开头: 使用网络图片<br/>2. 以 `/` 开头: 使用 `public` 目录中的图片<br/>3. 没有前缀: 相对于 markdown 文件的路径 |
| `tags`        | 文章标签。                                                                                                                                          |
| `category`    | 文章分类。                                                                                                                                          |
| `draft`       | 如果文章仍然是草稿,则不会显示。                                                                                                                        |
